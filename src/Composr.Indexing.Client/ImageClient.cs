...
namespace Composr.Indexing.Client
{
    public class ImageClient
    {
        ...
        public void ProcessImages()
        {
            ...
            CleanDirectory(Configuration.ImageSourceDirectory);
            foreach (var file in Directory.GetFiles(Configuration.ImageSourceDirectory, "*.jpg"))
        ...
        private void CleanDirectory(string imageSourceDirectory)
        {
            ...
            foreach (string file in Directory.GetFiles(Configuration.ImageDestinationDirectory))
                File.Delete(file);
        }
    }
}
